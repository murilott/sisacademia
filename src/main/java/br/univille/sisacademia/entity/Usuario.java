...
public class Usuario {
    ...
    // public List<String> getListaAlergiaString() {
    //     return listaAlergiaString;
    // }

    // public void setListaAlergiaString(List<String> listaAlergiaString) {
    //     this.listaAlergiaString = listaAlergiaString;
    // }
}
